...
if (isset($_POST['send_otp'])) {
    ...
    try {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'rivaldisklh625@gmail.com';
        $mail->Password = 'dxte jvub iyuq hhpl'; // Gunakan App Password jika 2FA aktif
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS; // Untuk port 465
        $mail->Port = 465; // Port untuk SSL
        $mail->setFrom('rivaldisklh625@gmail.com', 'XX1-Bival');
...
if (isset($_POST['verify_otp'])) {
    ...
    if ($otp_input == $_SESSION['otp'] && (time() - $_SESSION['otp_sent_time'] <
        ...
        $conn = new mysqli("localhost", "root", "", "bioskop_rival");
    ...
    <style>
        * {
        ...
        body {
            ...
            align-items: center;
            height: 100vh;
            background: linear-gradient(135deg, #C09A7F, #281E15);
            overflow: hidden;
        }
        ...
        .left {
            width: 40%;
            background: linear-gradient(135deg, #281E15, #C09A7F);
            color: white;
            display: flex;
