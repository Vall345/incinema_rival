...
<head>
    ...
    <title>History Pembelian - Studio G</title>
    ...
    <div class="flex">
        ...
        <div class="ml-64 p-6 w-full overflow-auto">
            <header class="bg-white p-4 rounded shadow mb-6 flex justify-between items-center">
                <h2 class="text-xl font-semibold">History Pembelian</h2>
            </header>
            <div class="bg-white p-4 rounded-lg shadow-md">
                <div class="overflow-x-auto">
                    <table id="filmTable" class="min-w-full border border-gray-300">
                        <thead>
                            <tr class="bg-blue-900 text-white" style="background-color: #916648;">
