...
<head>
    ...
    <title>Data Film - Studio G</title>
    ...
    <div class="flex">
        ...
        <main class="ml-64 p-6 w-full">
            <header class="bg-white p-4 rounded shadow mb-6 flex justify-between items-center">
                ...
                <button id="openModal" class="bg-blue-600 text-white px-4 py-2 rounded">Tambah Film</button>
            </header>
                ...
                <div class="bg-white p-6 rounded shadow-lg w-full md:w-1/2 max-h-[80vh] overflow-y-auto">
                    ...
                    <form action="../proses_input.php" method="POST" enctype="multipart/form-data">
                        <div class="mb-3">
                            ...
                            <input type="file" class="w-full border p-2 rounded" id="poster" name="poster"
                                accept="image/*" required>
                        </div>

                        <div class="mb-3">
                            <label class="block">Nama Film</label>
                            <input type="text" class="w-full border p-2 rounded" id="nama_film" name="nama_film"
                                required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="flex">
                                ...
                                <button type="button" id="addGenreBtn"
                                    class="bg-blue-600 text-white px-2 py-1 rounded ml-2">Tambah</button>
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="w-full border p-2 rounded" id="banner" name="banner"
                                accept="image/*" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="w-full border p-2 rounded" id="trailer" name="trailer"
                                accept="video/*">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="w-full border p-2 rounded" id="distributor" name="distributor"
                                required>
                        </div>
                        ...
                        <div class="flex justify-end">
                            <button type="button" id="closeModal"
                                class="bg-red-600 text-white px-4 py-2 rounded mr-2">Batal</button>
            ...
            <div class="bg-white p-6 rounded shadow overflow-x-auto">
                ...
                <table class="min-w-full border-collapse border border-gray-300">
                    <thead>
                        <tr class="bg-blue-800 text-white" style="background-color: #916648;">
