...
<head>
    ...
    <title>Jadwal Film - Studio G</title>
    ...
    <div class="flex">
        ...
        <main class="flex-1 p-6 ml-64">
            <header class="bg-white p-4 rounded shadow mb-6 flex justify-between items-center">
                ...
                <button class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700" data-bs-toggle="modal" data-bs-target="#modalTambahJadwal">
            ...
            <section class="bg-white p-6 rounded shadow overflow-x-auto">
                ...
                $sql = "SELECT jadwal_film.id, akun_mall.nama_mall, film.nama_film, film.poster, jadwal_film.total_menit,
                jadwal_film.tanggal_tayang, jadwal_film.tanggal_akhir_tayang , jadwal_film.jam_tayang_1, jadwal_film.jam_tayang_2,
                jadwal_film.jam_tayang_3, jadwal_film.studio
                FROM jadwal_film
                    ...
                    <?php
                        ...
                        foreach ($filmsByMall as $mallName => $films) {
                            foreach ($films as $film) {
                                ...
                                <td " . ($is_expired ? "style='background-color: red !important;'" : "") . " >{$film['studio']}</td> </tr>";
                                $no++;
                            }
                        }
                        ?>
